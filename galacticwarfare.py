...
def main_menu():
    ...
    while run:
        ...
        WIN.blit(title_label, (WIDTH/2 - title_label.get_width()/2, 310))

        title_label2 = title_font2.render("Use W A S D to control Ship", 1, (255,255,255))
        WIN.blit(title_label2, (WIDTH/2 - title_label2.get_width()/2, 340 + title_label.get_height()))
        
        title_label3 = title_font2.render("Use Spacebar to shoot Alien Invaders", 1, (255,255,255))
        WIN.blit(title_label3, (WIDTH/2 - title_label3.get_width()/2, 350 + title_label2.get_height() + title_label.get_height()))
